            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="documento" type="text" value="{{ $paciente->documento }}"
                        name="documento"
                    >
                    @error('documento')
                    <div class="alert alert-danger">
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="primer_nombre" type="text" value="{{ $paciente->primer_nombre }}"
                        name="primer_nombre"
                    >
                    @error('primer_nombre')
                    <div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="segundo_nombre" type="text" value="{{ $paciente->segundo_nombre }}"
                        name="segundo_nombre"
                    >
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="primer_apellido" type="text" value="{{ $paciente->primer_apellido }}"
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="segundo_apellido" type="text" value="{{ $paciente->segundo_apellido }}"
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        @foreach($generos as $genero)
                            <option
                                value="{{ $genero->id }}" {{ $paciente->genero->id == $genero->id ? 'selected' : '' }}>
                                {{ $genero->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        @foreach($departamentos as $departamento)
                            <option
                                value="{{ $departamento->id }}" {{ $paciente->departamento->id == $departamento->id ? 'selected' : '' }}>
                                {{ $departamento->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        @foreach($municipios as $municipio)
                            <option
                                value="{{ $municipio->id }}" {{ $paciente->municipio->id == $municipio->id ? 'selected' : '' }}>
                                {{ $municipio->nombre }}
                            </option>
                        @endforeach
                    </select>
